...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblTitulo.setBounds(109, 60, 237, 42);
		...
		lblValor.setBounds(72, 303, 211, 14);
		...
		JLabel btnsiguienteLabel = new JLabel("SIGUIENTE");
		btnsiguienteLabel.setFont(new Font("Dialog", Font.PLAIN, 18));
		btnsiguienteLabel.setHorizontalAlignment(SwingConstants.CENTER);
		btnsiguienteLabel.setForeground(new Color(255, 255, 255));
		btnsiguienteLabel.setBounds(0, 0, 122, 35);
		btnsiguiente.add(btnsiguienteLabel);
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				txtValor.setText("$");
				if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
					int dias = tiempoEstadia();
					if (dias > 0 && dias < 365) {
						txtValor.setText(String.valueOf(dias*25));
					}
				}
			}
		});
	...
	private void guardar() {
		...
		String fechaEntrada = formato.format(txtFechaEntrada.getDate());
		String fechaSalida = formato.format(txtFechaSalida.getDate());
	...
	public int tiempoEstadia() {
		int dias = (int) ((txtFechaSalida.getDate().getTime() - txtFechaEntrada.getDate().getTime())
				/ (1000 * 60 * 60 * 24));
		return dias;
	}
